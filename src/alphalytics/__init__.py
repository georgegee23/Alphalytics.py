...
__all__ = ["cross_sectional_spearmanr", "compute_spearman_stats", "factor_decay",
           "compute_series_quantiles", "to_quantiles", "compute_quantile_returns", "get_quantile_holdings", \
            "compute_mean_quantile_forward_return", "fwd_quantile_stats", 
            "plot_factor_data", "plot_cumulative_performance", "plot_quantiles_risk_metrics", "plot_quantile_correlations", "plot_spearman_rank", \
            "plot_ic_hist", "qqplot_ic", "plot_ic_summary", "plot_factor_decay", "plot_forward_returns", "plot_quantiles_annual_turnover", \
